...
class MainTableViewController: UITableViewController {
    ...
    //Data Set Array
    var image = ["01_ข่อย", "02_เทพทาโร", "03_ขิง", "04_ดีปลี", "05_หมาก", "06_ตาลตะโหนด", "07_ตะไคร้", "08_หมากผู้หมากเมีย", "09_ชะเอมเทศ", "10_ว่านกาบหอย", "11_ก้ามปูหลุด", "12_บานไม่รู้โรย", "13_ขมิ้ชัน", "14_เตยหอม", "15_ข่า", "16_กระชาย"]
    
    var Name = ["ข่อย","เทพธาโร", "ขิง", "ดีปลี", "หมาก", "ตาลตะโหนด", "ตะไคร้", "หมากผู้หมากเมีย", "ชะเอมเทศ", "ว่านกาบหอย", "ขมิ้นชัน", "เตยหอม", "ข่า" ]
    
    var Properties = ["แก้ท้องอืดท้องเฟ้อ, บำรุงธาต, ...", "แก้จุดเสียด, ขับลม, ...", "แก้โรคบิด, แก้อาหารท้องร่วง, ...", "แก้อาการริดสีดวงทวาร, ...", "แก้โรคบิด, ขับปัสสาวะ, ...","ขับปัสสาวะ","ขับปัสสาวะ","แก้ท้องเสีย, ...","ช่วยให้ชุ่มคอ, ...","แก้เจ็บคอ, แก้กระหายน้ำ, ...","แก้เจ็บคอ, แก้ไอ, ...","แก้ทางเดินปัสสาวะอักเสบ, ...","แก้ผดผื่นคัด, ...","แก้หัด, แก้อีสุกอีสัย, ...","ขับลม, รักษาโรคผิวหนัง, ....","รักษากลากเกลื้อน, ..."]
    
    var Scientific_name = ["Streblus asper", "Cinnamomum cassia", "Zingiber officinale", "Piper longum", "Glycyrrhiza glabra", "Tradescantia spathacea", "Tradescantia zebrina", "Gomphrena globosa", "Areca catechu Linn", "Borassus flabellifer Linn", "Cymbopogon citratus", "Cordyline fruticosa", "Curcuma longa", "Pandanus amaryllifolius", "Alpinia galanga", "Boesenbergia rotunda"]
